  ...
  render() {
    return (
        <nav className="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <Link to="/admin" className="navbar-brand brand-logo">
                <img src="./../../assets/admin/images/logo.png" alt="logo" />
            </Link>
            <Link to="/admin" className="navbar-brand brand-logo-mini">
                <img src="./../../assets/admin/images/logo.png" alt="logo" />
            </Link>
            </div>
                ...
                <ul className="navbar-nav navbar-nav-right">
                        ...
                        <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                            ...
                            <a className="dropdown-item preview-item">
                                <div className="preview-thumbnail">
                                    <img src="./../../assets/admin/images/faces/face4.jpg" alt="image" className="profile-pic" />
                                </div>
                            ...
                            <a className="dropdown-item preview-item">
                                <div className="preview-thumbnail">
                                    <img src="./../../assets/admin/images/faces/face2.jpg" alt="image" className="profile-pic" />
                                </div>
                                <div className="preview-item-content flex-grow">
                            ...
                            <a className="dropdown-item preview-item">
                                <div className="preview-thumbnail">
                                    <img src="./../../assets/admin/images/faces/face3.jpg" alt="image" className="profile-pic" />
                                </div>
                                <div className="preview-item-content flex-grow">
                    ...
                    <li className="nav-item dropdown d-none d-xl-inline-block">
                        <a className="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                            <span className="profile-text">Hello, Achinta Kundu !</span>
                            <img className="img-xs rounded-circle" src="./../../assets/admin/images/faces/face1.jpg" alt="Profile image" />
                        </a>
